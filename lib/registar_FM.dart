...
final FirebaseMessaging _firebaseMessaging = FirebaseMessaging.instance;
 ...
 getMobileToken() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Sign Up a Family Member",style: TextStyle(
                        color: Color(0xff212121),
                        fontWeight: FontWeight.w700,
                        fontSize: 20),),centerTitle: true, leading: Padding(
                    padding: const EdgeInsets.only(left: 8.0),
                    child: IconButton(icon: Icon(Icons.arrow_back_ios_new,color: Colors.black),onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => MyPage(),));},)),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue: FMinitials['name'] as String,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              new Expanded(
                                child: TextFormField(
                                  initialValue: FMinitials['email'] as String,
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  initialValue: FMinitials['phoneNo'] as String,
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextFormField(
                                  obscureText: true,
                                  initialValue: FMinitials['password'] ,
